...
| 11. Sparse structural work | `private_invariants::sparse_candidate_visits_ignore_population_times_segments` asserts 0 visits for 2,000 far-future cold soldiers across 49 unrelated schedule segments, then exactly 2,000 visits for 2,000 actual candidates; `cluster_11_huge_sparse_advance_has_exact_boundary_work` proves huge elapsed-time boundary counts |
