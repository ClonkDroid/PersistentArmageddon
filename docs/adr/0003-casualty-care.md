...
Uncontrolled wound rates add with checked integer arithmetic. At each due boundary blood loss precedes shock and death; entity order precedes treatment-ID order, so death interrupts a same-time completion. Controlled wounds cease bleeding. Shock treatment subtracts 300 shock and begins recovery; it never controls a wound.
